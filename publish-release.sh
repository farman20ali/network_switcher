...
echo -e "   ${BLUE}https://github.com/farman20ali/network_switcher/releases/new${NC}"
echo ""
echo "2. 📌 Choose tag:"
echo -e "   Select: ${GREEN}v${VERSION}${NC}"
echo ""
echo "3. ✏️  Fill in release details:"
echo -e "   Title: ${GREEN}Network Switcher v${VERSION}${NC}"
